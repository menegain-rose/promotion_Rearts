                ...
                <form action="" method="post">
                    <div class="md:flex items-center">
                        <div class="w-full md:w-1/2 flex flex-col">
                            ...
                            <input type="text" class="font-comfortaa text-white-primary p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-Rouge rounded" />
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="w-full flex flex-col mt-6">
                            ...
                            <textarea type="text" class="h-40 text-base font-comfortaa text-white-primary p-3 focus:outline-none focus:border-blue-700 mt-4 bg-Rouge border-0 rounded"></textarea>
                        </div>
                    </div>
